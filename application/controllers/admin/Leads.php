    ...
    public function lead($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            $datalead=array(
                ...
                'customeruniqueid'=>  $data['cuid']
            );
            $json_data = json_encode($datalead);
            $headers = array(
            ...
            if ($id == '') {
                ...
                if($id){
                    ...
                    curl_setopt_array($curl, array(
                        CURLOPT_URL => "http://192.236.154.5:780/api/Lead/CreateLead/",
                    ...
                    $leadid = $response_data[0]['mfLeadIdentifier'];
                    //$leadid = 45;
                    //if($leadid != 0){
                        $success     = $this->leads_model->update_leadid( $leadid,$id);
                 //  }
                   // $message = $id ? _l('added_successfully', _l('lead')) : '';
                }
                echo json_encode([
