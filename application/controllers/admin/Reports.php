...
class Reports extends AdminController
{
    ...
    public function __construct()
    {
        ...
        // Custom init - to facilitate visitors reports
    ...
    public function knowledge_base_articles()
    {
        ...
        /* See all visitor reports*/
    public function visitors()
    {
        // Data for the report filters
        ...
        $data['title']  = _l('visitor_reports');
        $this->load->view('admin/reports/visitors', $data);
    }
    /* List all tasks */
