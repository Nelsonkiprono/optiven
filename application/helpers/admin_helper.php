 ...
 * @param  mixed $staffid
 * @return boolean if user is not HOD
 */
function is_hod($staffid = '')
{
    ...
    return $CI->db->count_all_results(db_prefix() . 'departments') > 0 ? true : false;
}
 ...
 * @param  mixed $staffid
 * @return boolean if user is not supervisor
 */
function is_supervisor($staffid = '')
{
    ...
    return $CI->db->count_all_results(db_prefix() . 'subdepartments') > 0 ? true : false;
}

/**
 * @since  1.0.0
 * Check if current user is DSO
 * @param  mixed $staffid
 * @return boolean if user is not DSO
 */
function is_dso($staffid = '')
{
