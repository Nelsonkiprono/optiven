...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (has_permission('customers', '', 'view')
     ...
     $CI->app_menu->add_sidebar_menu_item('visitors', [
            'name'     => _l('visitors'),
            'position' => 10,
            'icon'     => 'fa fa-vimeo',
        ]);
        if (has_permission('visitors', '', 'view')){
        $CI->app_menu->add_sidebar_children_item('visitors', [
                'slug'     => 'visits',
                'name'     => _l('visits'),
                'href'     => admin_url('visitors'),
                'position' => 5,
        ]);
   }
        // $CI->app_menu->add_sidebar_children_item('visitors', [
        //         'slug'     => 'calendar',
        //         'name'     => _l('calendar'),
        //         'href'     => admin_url('visitors/calendar'),
        //         'position' => 10,
        // ]);
        ...
        $CI->app_menu->add_sidebar_children_item('visitors', [
                'slug'     => 'locations',
                'name'     => _l('location'),
                'href'     => admin_url('visitors/location'),
                'position' => 15,
        ]);

        $CI->app_menu->add_sidebar_children_item('visitors', [
                'slug'     => 'visitor_types',
                'name'     => _l('visitor_types'),
                'href'     => admin_url('visitors/types'),
                'position' => 20,
        ]);
if (has_permission('visitors', '', 'issue_items')) {
    ...
    $CI->app_menu->add_sidebar_menu_item('tasks', [
        ...
        $CI->app_menu->add_sidebar_menu_item('taskss', [
                'name'     => "Facebook",
                'href'     => admin_url('facebook'),
                'icon'     => 'fa fa-facebook',
                'position' => 35,
        ]);
        $CI->app_menu->add_sidebar_menu_item('units', [
                'name'     => _l('units'),
        ...
        // $CI->app_menu->add_sidebar_menu_item('3cxmanager', [
        //         'name'     => _l('3cxmanager'),
    ...
    if (has_permission('reports', '', 'view')) {
        ...
        $CI->app_menu->add_sidebar_children_item('reports', [
                    ...
                    'name'     => _l('visit'),
                    'href'     => admin_url('reports/visitors'),
                    'position' => 35,
            ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
                    'slug'     => 'tasks-reports',
                    'name'     => _l('tasks'),
                    'href'     => admin_url('reports/tasks'),
                    'position' => 40,
            ]);
    }
    ...
    if (is_admin()) {
        ...
        $CI->app_menu->add_setup_children_item('support', [
                    'slug'     => 'subdepartments',
                    'name'     => _l('acs_subdepartments'),
                    'href'     => admin_url('departments/subdepartments'),
                    'position' => 10,
            ]);
        $CI->app_menu->add_setup_children_item('support', [
