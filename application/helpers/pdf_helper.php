...
/**
 * Prepare parking template
 * @since  Version 1.0.0
 * @param  object $estimate estimate as object with all necessary fields
 * @param  string $tag tag for bulk pdf exporter
 * @return mixed object
 */
function parking_pdf($estimate= '', $tag = '')
{
    return app_pdf('visitor', LIBSPATH . 'pdf/Parking_pdf', $estimate, $tag);
}
 ...
 * @return mixed object
 */
function issue_pdf($estimate= '', $tag = '')
{
    return app_pdf('issue_item', LIBSPATH . 'pdf/Gate_pdf', $estimate, $tag);
}
