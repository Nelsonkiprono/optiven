...
function get_available_staff_permissions($data = [])
{
    ...
    $vistorPermissionsArray = [
        'view_own' => _l('permission_view_own'),
        'view'     => $viewGlobalName,
        'create'   => _l('permission_create'),
        'edit'     => _l('permission_edit'),
        'delete'   => _l('permission_delete'),
        'checkin'   => _l('permission_checkin'),
        'checkout'   => _l('permission_checkout'),
        'reject'   => _l('permission_reject'),
        'reschedule'   => _l('permission_reschedule'),
        'issue_items'   => _l('permission_issue_items'),
    ];
    ...
    $withoutViewOwnPermissionsArrayTask = [
        'view'   => $viewGlobalName,
        'create' => _l('permission_create'),
        'edit'   => _l('permission_edit'),
        'delete' => _l('permission_delete'),
        'approve' => _l('permission_approve'),
        'decline' => _l('permission_decline'),
    ];
    ...
    $withNotApplicableViewOwnTask = array_merge(['view_own' => ['not_applicable' => true, 'name' => _l('permission_view_own')]], $withoutViewOwnPermissionsArrayTask);
    ...
    $corePermissions = [
        ...
        'visitors' => [
            'name'         => _l('visits'),
            'capabilities' => $vistorPermissionsArray,
        ],
        'tasks' => [
            'name'         => _l('tasks'),
            'capabilities' => $withNotApplicableViewOwnTask,
             'help'        => [
        ...
        'dso' => [
            'name'         => _l('dso'),
            'capabilities' => $dsoPermissionsArray,
        ],

        'adso' => [
            'name'         => _l('adso'),
            'capabilities' => $adsoPermissionsArray,
        ],
    ];
