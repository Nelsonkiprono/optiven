...
class Leads_model extends App_Model
{
    ...
    public function getUnits($id = '')
    {
        ...
        $units = $this->db->get(db_prefix() . 'unit')->result_array();
...
//update leadid
public function update_leadid($leadid,$id)
    {

        $this->db->where('id',$id);
        $this->db->update(db_prefix() . 'leads', ['leadid' => $leadid ]);
