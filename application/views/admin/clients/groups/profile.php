         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php $value=( isset($client) ? $client->marketername : ''); ?>
                  <?php echo render_input( 'marketername', 'client_marketername',$value); ?>
                  <?php $value=( isset($client) ? $client->idnumber : ''); ?>
                  <?php echo render_input( 'idnumber', 'client_idnumber',$value); ?>
