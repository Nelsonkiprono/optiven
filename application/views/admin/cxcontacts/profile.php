   ...
   <div class="row">
      <div class="lead-view<?php if(!isset($lead)){echo ' hide';} ?>" id="leadViewWrapper">
         <div class="col-md-4 col-xs-12 lead-information-col">
            ...
            <p class="text-muted lead-field-heading"><?php echo _l('lead_unit'); ?></p>
            <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->unitnumber != '' ? $lead->unitnumber : '-') ?></p>
            <p class="text-muted lead-field-heading"><?php echo _l('lead_marketername'); ?></p>
            <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->marketername != '' ? $lead->marketername : '-') ?></p>
            <p class="text-muted lead-field-heading"><?php echo _l('leads_budget'); ?></p>
            <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->budget != '' ? $lead->budget : '-') ?></p>           
      ...
      <div class="lead-edit<?php if(isset($lead)){echo ' hide';} ?>">
         ...
         <div class="col-md-6 cl-filter-column">
               <?php echo render_select('cuid',$clcustomers,array('customerID',array('phonenumber','company')),'Select Customer','',array('data-width'=>'100%','data-none-selected-text'=>_l('cl_customer')),array(),'no-mbot'); ?>
           </div>
           <div class="col-md-6">
           <?php echo render_input('budget','Budget',$value); ?>
           </div>
           <div class="col-md-6 cl-filter-column">
               <?php echo render_select('unitnumber',$clunits,array('unitnumber',array('name')),'Select Unit','',array('data-width'=>'100%','data-none-selected-text'=>"Unit"),array(),'no-mbot'); ?>
           </div>
           <div class="col-md-6">
           <?php echo render_input('locationofinterest','Location of Interest',''); ?>
           </div>
         <div class="col-md-6">
