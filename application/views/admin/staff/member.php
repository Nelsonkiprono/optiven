                  ...
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                     ...
                     <div class="form-group">
                        ...
                        <div class="checkbox checkbox-primary">
                           ...
                           $subdepartmets = $this->visitors_model->get_subdepartments($department['departmentid']);
                        ...
                        <?php 
                        // echo json_encode($subdepartmets);
                        foreach($subdepartmets as $subdepartmet){

                             $checked1 = '';
                              if(isset($member)){
                               foreach ($staff_subdepartments as $staff_subdepartment) {
                                if($staff_subdepartment['subdepartmentid'] == $subdepartmet['subdepartmentid']){
                                 $checked1 = ' checked';
                               }
                              }
                              }
                        ?>
                         <div class="checkbox checkbox-primary mleft10">
                           <input type="checkbox" id="dep_<?php echo $subdepartmet['subdepartmentid']; ?>" name="subdepartments[]" value="<?php echo $subdepartmet['subdepartmentid']; ?>" <?php echo $checked1; ?>>
                           <label  for="dep_<?php echo $subdepartmet['subdepartmentid']; ?>" style="color: green;font-weight: bold;"><?php echo $subdepartmet['name']; ?></label>
                         </div>
                        <?php }?>
                        <?php } ?>
                     </div>
