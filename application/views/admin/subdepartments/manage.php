                    ...
                    <div class="panel-body">
                     <div class="_buttons">
                        <a href="#" onclick="new_department(); return false;" class="btn btn-info pull-left display-block">
                            <?php echo _l('new_sub_department'); ?>
                        </a>
                    </div>
...
<div class="modal fade" id="department" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('departments/subdepartment')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('edit_department'); ?></span>
                    <span class="add-title"><?php echo _l('new_sub_department'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input('name','sub_department_name'); ?>
                                           <?php
                           echo render_select('departmentid',$departments,array('departmentid',array('name')),'Parent Department','');
                          ?>
                        ...
                        <?php echo render_input('email','department_email','','email'); ?>
                          <?php
                           echo render_select('supervisor',$staff,array('staffid',array('firstname','lastname')),'Supervisor','');
                          ?>
