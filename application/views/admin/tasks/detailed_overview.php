            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-2 border-right">
                        <?php
                           echo render_select('dept',$departments,array('departmentid',array('name')),'',$dept_id,array('data-none-selected-text'=>_l('all_staff_departments')),array(),'no-margin'); ?>
                     </div>
                     <?php } ?>
                     <div class="col-md-2 border-right">
                        <?php
                  ...
                  <table class="table tasks-overview dt-table scroll-responsive">
                     <thead>
                        <tr>
                           ...
                           <th><?php echo _l('tasks_department'); ?></th>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td data-order="<?php echo $task['department']; ?>"><?php echo getDepartmentName($task['staffid']); ?></td>
