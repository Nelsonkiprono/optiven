            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="_buttons">
                     ...
                     <?php } ?>
                      <a href="#__add_location" data-toggle="modal" class="btn btn-primary mright5 test pull-left display-block">
                     ...
                     $_table_data = array(
                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="clients"><label></label></div>',
                       array(
                         ...
                         array(
                         'name'=>_l('location_list_details'),
                         'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-list-details')
                        ),
                         array(
                         'name'=>_l('location_description'),
...
<script>
   $(function(){
       ...
       var tAPI = initDataTable('.table-visitors', admin_url+'visitors/locationtable', [0], [0], CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(2,'asc'))); ?>);
