            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="_buttons">
                    ...
                    <a href="#__add_types" data-toggle="modal"  class="btn btn-primary mright5 test pull-left display-block">
                    Add Types</a>
...
<script>
   $(function(){
       ...
       var tAPI = initDataTable('.table-visitors', admin_url+'visitors/typetable', [0], [0], CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(2,'asc'))); ?>);
