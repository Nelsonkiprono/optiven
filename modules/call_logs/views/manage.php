                        ...
                        <div class="row">
                            <div class="col-lg-8">
                               <div class="_buttons">
                                ...
                                <a href="<?php echo admin_url('cxcontacts'); ?>" data-toggle="tooltip" title="<?php echo _l('cxcontacts'); ?>" class="btn btn-default"><i class="fa fa-bar-chart" aria-hidden="true"></i> <?php echo _l('cxcontacts'); ?></a>
